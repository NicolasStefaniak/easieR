...
function(X=NULL, Y=NULL, group=NULL, choix=NULL,
  ...
  test.t.in<-function(X=NULL, Y=NULL, data=NULL, choix=NULL, param=NULL, outlier=NULL, sauvegarde=NULL, info=T, group=NULL,alternative="two.sided", 
    ...
    if(is.null(formula)){
      ...
      if(format=="large") {
        ...
        title1<-"Variable-s dépendante-s"
        title2<-"Variable indépendante"
  ...
  apparies<-function(X, Y, data=NULL, param=c("param", "non param", "robustes"),alternative="two.sided", n.boot=NULL, rscale=0.707){
    ...
    if(any(param=="param") | any(param=="Test paramétrique", any(param=="Bayes") | any(param=="Facteurs bayesiens"))) {
    ...
    Resultats$"Moyenne et écart-type pour les données non ajustées"<-nonaj
    ...
    Resultats$"Moyenne et écart-type pour les données ajustées"<-aj
  ...
  indpdts<-function(X, Y, data, param=c("param", "non param","robustes"),alternative="two.sided", n.boot=NULL, rscale=0.707){
    ...
    if(any(param=="param") | any(param=="Test paramétrique")){
      ...
      Resultats$"Représentation graphique - Moyenne et écart-type"<-p
